    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.PositiveSmallIntegerField(verbose_name='卓番')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='来店日時')),
                ('created_bt', models.DateTimeField(auto_now=True, verbose_name='登録日')),
            ],
            options={
                'verbose_name': '注文',
